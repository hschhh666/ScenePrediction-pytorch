...
if __name__ == '__main__':
    ...
    resultDir = '/home/hsc/Research/StateMapPrediction/code/models/finalModel/EastAndSouth/resultDir/'#可视化结果保存在这里
    ...
    if TestOrTrain =='train':
        ...
        for epoch in range(2000):#500个epoch
            ...
            if testing_loss < lastTestingLoss:
                ...
                torch.save(EastModel.state_dict(), '/home/hsc/Research/StateMapPrediction/code/models/finalModel/EastAndSouth/modelParam/Easemodel.pth')
                torch.save(SouthEastModel.state_dict(), '/home/hsc/Research/StateMapPrediction/code/models/finalModel/EastAndSouth/modelParam/SEmodel.pth')
    ...
    if TestOrTrain == 'test':
        ...
        EastModel.load_state_dict(torch.load('/home/hsc/Research/StateMapPrediction/code/models/finalModel/EastAndSouth/modelParam/Easemodel.pth'))
        SouthEastModel.load_state_dict(torch.load('/home/hsc/Research/StateMapPrediction/code/models/finalModel/EastAndSouth/modelParam/SEmodel.pth'))
        EastModel.to(device)
        SouthEastModel.to(device)

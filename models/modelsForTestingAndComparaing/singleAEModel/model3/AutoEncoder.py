...
class BehaviorModelAutoEncoder(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(3,6,3,padding=1,stride=2)
        self.conv3 = nn.Conv2d(6,9,3,padding=1,stride=2)
        self.fc1 = nn.Linear(9*64*64,9*32*32)
        self.fc2 = nn.Linear(9*32*32,20)

        self.fc3 = nn.Linear(20,9*32*32)
        self.fc4 = nn.Linear(9*32*32,9*64*64)        
...
if __name__ == '__main__':
    ...
    modelParamPATH = '/home/hsc/Research/StateMapPrediction/code/models/model3/modelParam/AEModelParam.pth'#模型参数保存在这里
    resultDir = '/home/hsc/Research/StateMapPrediction/code/models/model3/resultDir/'#可视化结果保存在这里

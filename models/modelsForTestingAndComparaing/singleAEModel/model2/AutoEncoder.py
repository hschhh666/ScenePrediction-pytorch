...
if __name__ == '__main__':
    ...
    modelParamPATH = '/home/hsc/Research/StateMapPrediction/code/models/model2/modelParam/AEModelParam.pth'#模型参数保存在这里
    resultDir = '/home/hsc/Research/StateMapPrediction/code/models/model2/resultDir/'#可视化结果保存在这里
